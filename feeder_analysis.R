...
regbusi.tex <-
  stargazer(reg_busi1, 
            ...
            #     round(mean(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi")])], na.rm = T),2),
            #     round(mean(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi", "Shape_AreaKM")])], na.rm = T),2),
            #     round(mean(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi", "Shape_AreaKM", "Population")])], na.rm = T),2)
            #     ),
            #   c("Std. deviation of dependent variable", 
            #     round(sd(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi")])], na.rm = T),2),
            #     round(sd(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi", "Shape_AreaKM")])], na.rm = T),2),
            #     round(sd(regVill_df$N_busi[complete.cases(regVill_df[,c("N_busi", "Shape_AreaKM", "Population")])], na.rm = T),2)
            #     )
            # )
  )
