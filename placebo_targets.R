...
#------------------------------------------------------------------------------#
#### Load targets from 2015 to 2018 ####

ntar<-  read.xlsx("esic4560.xlsx")

ntar <- ntar %>% 
  separate(ano_mes, c("year", "month"), "m") %>% 
...
# I can't do a regular merge. I need to replace values (all NAs) for the periods
# for wich we did not have information, from 2015 2 to 2018 2
...
#------------------------------------------------------------------------------#
#### Recreate old variables for new periods ####

# Recreate variables used in the regressions, but not yet constructed for new periods
...
# Roubo de rua
png("Results/rr_placebo_fit.png",
    width = 730, height = 480)
...
# Base atualisad com 2 semestre de 2015 a 2018
