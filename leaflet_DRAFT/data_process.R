...
# feeder_sample	<- readOGR(file.path(ROADS, "Sample"), "feeder_sample_abr18")
...
# district_rd	 	<- spTransform(district_rd	, RwaProj)
# national_rd 	<- spTransform(national_rd	, RwaProj)
# feeder_sample	<- spTransform(feeder_sample, RwaProj)
